...
-- Disable verbose debug logging to prevent huge log files
...
-- NM: need to explore diagnistics from LSPs, etc.  seems cool
-- Diagnostic keymaps
...
-- NM: dogmatic bullshit.  arrows are a fine way to move in insert mode
